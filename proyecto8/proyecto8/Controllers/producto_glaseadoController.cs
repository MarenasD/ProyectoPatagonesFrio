...
namespace proyecto8.Controllers
{
    public class producto_glaseadoController : Controller
    {
        ...
        {
            var producto_glaseado = db.producto_glaseado.Include(p => p.estado_glaseado).Include(p => p.producto_proceso).Include(p => p.producto);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.fk_id_producto_proceso = new SelectList(db.producto_proceso, "id_producto_proceso", "id_producto_proceso");
        ...
        public ActionResult Create([Bind(Include = "id_producto_glaseado,cantidad_glaseada,fecha_glaseada,fk_id_producto_proceso,fk_id_estado_glaseado")] producto_glaseado producto_glaseado)
        {
            ...
            ViewBag.fk_id_producto_proceso = new SelectList(db.producto_proceso, "id_producto_proceso", "id_producto_proceso", producto_glaseado.fk_id_producto_proceso);
