...
namespace PatagonesF.Controllers
{
    public class proveedor_productoController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.fk_id_proveedor = new SelectList(db.proveedor, "rut_proveedor", "nombre_proveedor");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id_producto_proveedor,fk_id_producto,fk_id_proveedor")] proveedor_producto proveedor_producto)
        {
            ...
            ViewBag.fk_id_proveedor = new SelectList(db.proveedor, "rut_proveedor", "nombre_proveedor", proveedor_producto.fk_id_proveedor);
            return View(proveedor_producto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_producto_proveedor,fk_id_producto,fk_id_proveedor")] proveedor_producto proveedor_producto)
        {
            if (ModelState.IsValid)
            {
